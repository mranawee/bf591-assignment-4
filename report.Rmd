...
size of our dataset if memory issues are a constraint. Implement the `read_data` 
function in `main.R` to read in the dataset, then use the `filter_zero_var_genes` 
function, also in `main.R` to remove zero variance genes from the count matrix, 
and return a list containing both the name of the returned genes, and the counts 
of each gene for every sample.

1a. import data
```{r}
#Read in raw_counts.tsv and display the head of the resulting tibble
